...
def is_q1_correct():
    ...
    input_file = os.path.join(os.path.dirname(__file__), 'data_private', 'input_df.parquet')
    ...
    # get the output 
    output_file = os.path.join(os.path.dirname(__file__), 'data_private', 'output_df.parquet')
